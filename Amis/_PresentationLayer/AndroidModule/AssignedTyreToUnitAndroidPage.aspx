<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignedTyreToUnitAndroidPage.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.AssignedTyreToUnitAndroidPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table style="width: 100%; border: solid" border="1">
                    <tr>
                        <td style="width: 100%; text-align: center">
                            <asp:Label ID="lblTittle" runat="server" Width="100%" Text="Asignar neumático" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 60%; text-align: center">
                            ...
                            <input type="button" value='Leer' style="width:100%" id="btnReadRfiTag" runat="server" onclick='ReadTag();'/>
                        <td style="width: 20%">
                            <asp:Button runat="server" ID="btnReadTag" CssClass="Opacity" ClientIDMode="Static"  Text="Leer Tag" OnClick="btnReadTag_Click" Width="1%" />
                            <asp:TextBox runat="server" CssClass="Opacity" ID="txtTyreTag" Width="1%" Visible="true" ></asp:TextBox>   
                        </td>
                    </tr>
                </table> 
                <br />
                <table style="width: 100%">
                    <tr>
                        <td style="width: 20%"></td>
                        <td style="width: 60%; text-align: center">
                <asp:Button  runat="server" ID="btnBack" Text="Volver" Width="100%" OnClick="btnBack_Click" />
                        <td style="width: 20%"></td>
                    </tr>
                </table>
                            <%-- Mpe--%>
                <asp:Button ID="btnConfirmar" style="display:none" runat="server"/>
            <cc1:ModalPopupExtender ID="mpeAnotherAssign" runat="server" 
                    ...
                    <div id="popupHeaderConfirmar">
                        ...
                        <table id="Table1" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 20%"></td>
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="lblText" runat="server" Text="¿La asignación ha sido correcta, desea otra asignación?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
                        ...
                        <table id="Table5" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 10%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnYesAnotherAssign" runat="server" Text="Si" Width="100%" Height="20px" OnClick="btnYesAnotherAssign_Click"/>
                                </td>
                                <td style="width: 20%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnNoAnotherAssign" runat="server" Text="No" Width="100%" Height="20px" OnClick="btnNoAnotherAssign_Click"/>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                        </table>
            ...
            <cc1:ModalPopupExtender ID="mpeSameUnit" runat="server" 
            ...
            <div id="panReplace" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                    <div id="popupHeaderConfirmarReplace">
                        ...
                        <table id="Table8" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 20%"></td>
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="Label3" runat="server" Text="¿En la misma unidad?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
                        ...
                        <table id="Table10" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 10%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnYesSameUnit" runat="server" Text="Si" Width="100%" Height="20px" OnClick="btnYesSameUnit_Click"/>
                                </td>
                                <td style="width: 20%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnNoSameUnit" runat="server" Text="No" Width="100%" Height="20px" OnClick="btnNoSameUnit_Click"/>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                        </table>
                 ...
                 <%-- Mpe not Pressure setting--%>
                <asp:Button ID="btnNotPressureSetting" Style="display: none" runat="server" />
                <cc1:ModalPopupExtender ID="mpeNotPressureSetting" runat="server"
                    TargetControlID="btnNotPressureSetting" CancelControlID="btnNotPressureSetting" OkControlID="btnNotPressureSetting"
                    PopupControlID="panNoPressureSetting">
                </cc1:ModalPopupExtender>
                <div id="panNoPressureSetting" class="popupPanelClass" style="display: none; height: 215px;">
                    <div class="popupContainerClass">
                            ...
                            <div style="background-color: lightgray">
                                ...
                                <table id="Table38" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%; text-align: center">
                                            <asp:Label ID="Label21" runat="server" Text="Según nuestros registros,dentro de las caracteristicas del neumático a asignar, no posee configuración de presión, por lo cual es imposible asignarlo a alguna unidad, por favor comuniquese con el soporte del sistema."></asp:Label>
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
                                ...
                                <table id="Table40" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%">
                                            <asp:Button ID="btnNotPressureSettingOk" runat="server" Text="Entendido" Width="100%" Height="20px" OnClick="btnNotPressureSettingOk_Click" />
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
                 ...
                 <%-- Mpe not Depth Setting--%>
                <asp:Button ID="btnNotDepthSetting" Style="display: none" runat="server" />
                <cc1:ModalPopupExtender ID="mpeNotDepthSetting" runat="server"
                    TargetControlID="btnNotDepthSetting" CancelControlID="btnNotDepthSetting" OkControlID="btnNotDepthSetting"
                    PopupControlID="panNotDepthSetting">
                </cc1:ModalPopupExtender>
                <div id="panNotDepthSetting" class="popupPanelClass" style="display: none; height: 215px;">
                    <div class="popupContainerClass">
                        <div id="popupHeaderNotPRessureSetting">
                            <div style="background-color: black;">
                            ...
                            <div style="background-color: lightgray">
                                ...
                                <table id="Table13" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%; text-align: center">
                                            <asp:Label ID="Label6" runat="server" Text="Según nuestros registros,dentro de las caracteristicas del neumático a asignar, no posee configuración de profundidad, por lo cual es imposible asignarlo a alguna unidad, por favor comuniquese con el soporte del sistema."></asp:Label>
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
                                ...
                                <table id="Table15" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%">
                                            <asp:Button ID="btnNotDepthSettingOk" runat="server" Text="Entendido" Width="100%" Height="20px" OnClick="btnNotDepthSettingOk_Click"/>
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
