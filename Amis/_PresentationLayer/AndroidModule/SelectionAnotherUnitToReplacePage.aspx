<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectionAnotherUnitToReplacePage.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.SelectionAnotherUnitToReplacePage" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                    ...
                    <tr>
                        <td style="width: 100%; text-align: center">
                            <asp:Label ID="lblTittle" runat="server" Width="100%" Text="Recambio - Unidad receptora" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <div id="panConfirmar" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                 ...
                 <%--Mpe2 --%>
                <asp:Button ID="btnAnotherReplace" style="display:none" runat="server"/>
            <cc1:ModalPopupExtender ID="mpeAnotherReplace" runat="server" 
                TargetControlID="btnAnotherReplace" CancelControlID="btnAnotherReplace" OkControlID="btnAnotherReplace"
                PopupControlID="panAnotherReplace">
            </cc1:ModalPopupExtender>
            <div id="panAnotherReplace" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                    <div id="popupHeaderAnotherReplace">
                        <div style="background-color: black;">
                        ...
                        <table id="Table8" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 20%"></td>
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="Label3" runat="server" Text="¿Otro cambio de posición?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
                        ...
                        <table id="Table10" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 10%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnYesAnotherReplace" runat="server" Text="Confirmar" Width="100%" Height="20px" OnClick="btnYesAnotherReplace_Click"/>
                                </td>
                                <td style="width: 20%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnNoAnotherReplace" runat="server" Text="Cancelar" Width="100%" Height="20px" OnClick="btnNoAnotherReplace_Click"/>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                        </table>
