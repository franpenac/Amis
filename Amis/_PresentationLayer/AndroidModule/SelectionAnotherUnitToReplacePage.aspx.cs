...
{
    public partial class SelectionAnotherUnitToReplacePage : System.Web.UI.Page
    {
        ...
        protected void btnConfirmarPoppup_Click(object sender, EventArgs e)
        {
            ...
            if (unitAsset == null)
            {
                ...
                List<Button> listB = (List<Button>)Session["ListButtons2"];
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            Session["ListButtons2"] = null;
            ChargeButtons();
            mpeConfirmar.Hide();
        }

        protected void btnYesAnotherReplace_Click(object sender, EventArgs e)
        {
            Session["ListButtons2"] = null;
            Session["UnitFind2"] = null;
            Session["internalNumber2"] = null;
            Session["Patent2"] = null;
            Session["Contador2"] = null;
            Response.Redirect("SelectionReplaceTyrePage.aspx");
