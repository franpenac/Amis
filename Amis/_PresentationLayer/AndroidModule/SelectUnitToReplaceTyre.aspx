<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectUnitToReplaceTyre.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.SelectUnitToReplaceTyre" %>
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 30%">
                            <asp:TextBox ID="txbTagUnit" runat="server" CssClass="btnInv"></asp:TextBox>
                        </td>
                        <td style="width: 30%">
                            <asp:Button ID="btnSearch" runat="server" Text="Buscar" CssClass="btnInv" OnClick="btnSearch_Click"/>
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 20%"></td>
                        <td style="width: 60%; text-align: center">
                            <asp:Button runat="server" ID="btnBack" Width="100%" Text="Volver" OnClick="btnBack_Click"/>
                        </td>
                        <td style="width: 20%"></td>
                    </tr>
                </table>
