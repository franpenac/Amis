<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectionReplaceTyrePage.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.SelectionReplaceTyrePage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReadTyreTagReplace() {
            ...
            var button = getControl('btnReadTagTyre');
            button.click();
        }
    </script>
</head>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="width: 10%">
                            <asp:Button runat="server" ID="btnReadTagTyre" ClientIDMode="Static" OnClick="btnReadTyreTag_Click" Text="Leer Tag" CssClass="btnInv" />
                        </td>
                        <td style="width: 30%; text-align: center">
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 20%">
                            <input type="button" runat="server" value='Leer tag' id="btnReadRfiTag" onclick='ReadTyreTagReplace();' disabled="disabled" style="width: 100%" />
                        </td>
                        <td style="width: 50%">
                            <asp:TextBox runat="server" ID="txtTyreTag" CssClass="btnInv"></asp:TextBox>
                        </td>
                        <td style="width: 30%">
                            <asp:Button runat="server" ID="btnFinishInspection" Text="Volver al menú" CssClass="btnRight" OnClick="btnBack_Click" />
                        </td>
                    </tr>
                </table>
                <hr />
                            ...
                            <div style="background-color: lightgray">
                                ...
                                <table id="Table8" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%; text-align: center">
                                            <asp:Label ID="Label3" runat="server" Text="El recambio del neumático se realizó correctamente, ¿Desea realizar otro recambio?"></asp:Label>
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
