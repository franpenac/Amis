<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairAssetAndroidPage.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.RepairAssetAndroidPage" Async="true"%>
                ...
                <table style="width: 100%; border:solid" border="1">
                    <tr>
                        <td style="width: 100%; text-align: center">
                            <asp:Label ID="lblTittle" runat="server" Width="100%" Text="Reparar" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 60%; text-align: center">
                            <asp:Label ID="Label2" runat="server" Width="100%" Text="Entregue al encargado de Administración de activos." ForeColor="Red"></asp:Label>
                        </td>
                        <td style="width: 20%"></td>
                    </tr>
                    <tr>
                        <td style="width: 20%"></td>
                        <td style="width: 60%; text-align: center">
                            <asp:Label ID="Label3" runat="server" Width="100%" Text="Se envió un aviso a su supervisor de este envió a reparación" ForeColor="Red"></asp:Label>
                        </td>
                        <td style="width: 20%"></td>
                    </tr>
                </table>
                 ...
                 <table style="width:100%">
                    <tr>
                        ...
                        <td style="width:10%; align-items:center;position:center">
                            <asp:ImageButton ID="imgNext" runat="server" ImageUrl="~/ig_common/images/right_row.png" OnClick="imgNext_Click" style="height: 26px" />
