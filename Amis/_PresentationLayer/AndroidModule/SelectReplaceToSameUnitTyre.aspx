...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectReplaceToSameUnitTyre.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.SelectReplaceToSameUnitTyre" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                    ...
                    <tr>
                        <td style="width: 100%; text-align: center">
                            <asp:Label ID="lblTittle" runat="server" Width="100%" Text="Cambio en misma unidad" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <div id="panConfirmar" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                    <div id="popupHeaderConfirmar">
                        ...
                        <table id="Table1" runat="server" style="Width:100%">
                            <tr>
                                ...
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="lblText" runat="server" Text="¿Está seguro?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
                        ...
                        <table id="Table5" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 10%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnConffirmChange" runat="server" Text="Si" Width="100%" Height="20px" OnClick="btnYesChange_Click"/>
                                </td>
                                <td style="width: 20%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnNoChange" runat="server" Text="No" Width="100%" Height="20px" OnClick="btnNoChange_Click"/>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                        </table>
                 ...
                 <%-- Mpe confirmar cambio de posicion en inspeccion--%>
                <asp:Button ID="btnConffirmInspectionChange" style="display:none" runat="server"/>
            <cc1:ModalPopupExtender ID="mpeConffirmInspectionChange" runat="server" 
                TargetControlID="btnConffirmInspectionChange" CancelControlID="btnConffirmInspectionChange" OkControlID="btnConffirmInspectionChange"
                PopupControlID="panConffirmChange">
            </cc1:ModalPopupExtender>
            <div id="panConffirmChange" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                    <div id="popupHeaderConfirmarChange">
                        <div style="background-color: black;">
                        ...
                        <table id="Table10" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 10%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnYesInspectionChange" runat="server" Text="Si" Width="100%" Height="20px" OnClick="btnYesInspectionChange_Click"/>
                                </td>
                                <td style="width: 20%"></td>
                                <td style="width: 30%">
                                    <asp:Button ID="btnNoInspectionChange" runat="server" Text="No" Width="100%" Height="20px" OnClick="btnNoInspectionChange_Click"/>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                        </table>
