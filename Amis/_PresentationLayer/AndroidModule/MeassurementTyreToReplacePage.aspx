<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeassurementTyreToReplacePage.aspx.cs" Inherits="amis._PresentationLayer.AndroidModule.MeassurementTyreToReplacePage"  Async="true"%>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function takeMeasurements() {
            var button2 = getControl('btnTakeMeasurements');
            button2.disabled = true;
            AndroidInterface.androidShowMessage('Por favor comienze a medir profundidad.');
            ...
            if (values[0].indexOf('error') == -1 || values[1].indexOf('error') == -1 || values[2].indexOf('error') == -1) {
                ...
                getControl('txtMeassureDepth1').value = values.split('/')[0];
                getControl('txtMeassureDepth2').value = values.split('/')[1];
                getControl('txtMeassureDepth3').value = values.split('/')[2];
        ...
        function takePressure() {
            var button1 = getControl('btnTakePressure');
            button1.disabled = true;
            AndroidInterface.androidShowMessage('Por favor comienze a medir presión.');
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width:30%">
                            <input type='button' runat="server" value='Medir Profundidad' id="btnTakeMeasurements" style="float:right; width:100%" onclick='takeMeasurements();' />
                        </td>
                    </tr>
                </table>
                <hr />
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width:70%">
                            ...
                            <asp:TextBox runat="server" ClientIDMode="Static" ID="txtMeassureDepth3" AutoPostBack="true" Width="35px" Enabled="false"></asp:TextBox>
                        </td>
                        <td style="width:20%">
                            <asp:Button runat="server" ID="btnCancelMeassureDepth" CssClass="btnCancel" OnClick="btnCancelMeassureDepth_Click" />
                        </td>
                    </tr>
                    </table>
                <hr />
                    ...
                    <tr>
                        ...
                        <td style="width:40%"></td>
                        <td style="width:30%">
                            <input type='button' runat="server" value='Medir Presión' id="btnTakePressure" style="float:right; width:100%" onclick="takePressure();" disabled="disabled"/>
                        </td>
                    </tr>
                </table>
                <hr />
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td style="width:40%">
                            <asp:Button runat="server" ID="btnNext" Text="Continuar" OnClick="btnNext_Click" Visible="false"/>
                        </td>
                        <td style="width:30%"></td>
                    </tr>
                </table>
                ...
                <cc1:ModalPopupExtender ID="mpeToScrap" runat="server"
            ...
            <cc1:ModalPopupExtender ID="mpeCancelDepthMeassurement" runat="server" 
                    ...
                    <div id="popupHeaderCancelDepth">
                        ...
                        <table id="Table6" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 20%"></td>
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="Label7" runat="server" Text="¿Seguro que desea cancelar el proceso de medición de profundidad?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
            ...
            <div id="panCancelPressure" class="popupPanelClass" style="display:none; height:215px;">
                <div class="popupContainerClass">
                    <div id="popupHeaderCancelPre">
                        <div style="background-color: black;">
                        <asp:Table ID="Table7" runat="server" BorderStyle="Solid" BorderWidth="0.5px" Height="20px" Width="100%">
                            <asp:TableHeaderRow BorderStyle="Solid" BorderWidth="0.5px">
                                <asp:TableHeaderCell BorderStyle="Solid" BorderWidth="0.5px">
                                    <div style="font-family: Arial; font-size: 20px">
                        ...
                        <table id="Table8" style="Width:100%" runat="server" >
                            <tr>
                                <td style="width: 40%"></td>
                                <td style="width: 20%"></td>
                                <td style="width: 40%"></td>
                        ...
                        <table id="Table9" runat="server" style="Width:100%">
                            <tr>
                                <td style="width: 20%"></td>
                                <td style="width: 60%; text-align:center">
                                    <asp:Label ID="Label6" runat="server" Text="¿Seguro que desea cancelar el proceso de medición de presión?"></asp:Label>
                                </td>
                                <td style="width: 20%"></td>
                            </tr>
                        </table>
                            ...
                            <div style="background-color: lightgray">
                                ...
                                <table id="Table14" runat="server" style="width: 100%">
                                    <tr>
                                        <td style="width: 20%"></td>
                                        <td style="width: 60%; text-align: center">
                                            <asp:Label ID="Label1" runat="server" Text="Error al medir profundidad, por favor vuelva a medir."></asp:Label>
                                        </td>
                                        <td style="width: 20%"></td>
                                    </tr>
                                </table>
