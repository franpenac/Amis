<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModelPurchasedReportPage.aspx.cs" Inherits="amis._PresentationLayer.Report.ModelPurchasedReportPage" %>
            ...
            <div style="margin: 10px" class="auto-style4">
                ...
                <table>
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <div style="font-family: Arial; font-size: 13px">
                                <asp:Label ID="lblWarehouse" runat="server" Text="Proveedor"></asp:Label>
                            </div>
                        </td>
                        <td style="vertical-align: top">&nbsp;</td>
                        <td style="vertical-align: top">
                    ...
                    <tr>
                        ...
                        <td>
                            <ig:WebDropDown ID="wddYear" runat="server" Width="143px" EnableAutoFiltering="Client" AutoSelectOnMatch="False">
                            </ig:WebDropDown>
                        </td>
                    </tr>
                </table>
