<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WucSettingCat.ascx.cs" Inherits="amis._PresentationLayer.Configuration.WucSettingCat" %>
        ...
        <table class="auto-style6">
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <ig:WebNumericEditor ID="wneCapacity" Width="200px" CssClass="textBoxDesign" onkeyPress="return textbox_number_onkeypress(event)" runat="server"></ig:WebNumericEditor>
                </td>
            </tr>
        </table>
