<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DepthSettingPage.aspx.cs" Inherits="amis._PresentationLayer.Configuration.DepthSettingPage" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="margin: 10px">
                ...
                <br></br><h1 id="h1OptionMenuPageName" runat="server">
                    Configuración Mínima Recapado
                </h1>
                ...
                <table>
                        ...
                        <tr>
                            <td style="vertical-align: top; padding-top:5px; text-align:right" class="auto-style6;">
                                <div style="font-family: Arial; font-size: 13px">
                                    <br />
                                    <asp:Label ID="lblAplication" runat="server" Text="Aplicación"></asp:Label>
                                </div>
                            </td>
                            <td style="vertical-align: top" class="auto-style3"></td>
                            <td style="vertical-align: top" class="auto-style3">&nbsp;<ig:WebDropDown ID="wddApplication" CssClass="textBoxDesign" runat="server" Width="280px" EnableAutoFiltering="Server" AutoSelectOnMatch="False">
                                </ig:WebDropDown>
                            </td>
                            <tr>
                                <td class="auto-style4" style="vertical-align: top">&nbsp;</td>
                        ...
                        <div style="font-family: Arial; font-size: 13px; width: 222px">
                                <br />
                                <asp:Label ID="lblNumberDepth" runat="server" Text="Configuración Mínima Recapado (mm)"></asp:Label>
                            </div>
                        </td>
                        <td style="vertical-align: top">&nbsp;</td>
                        <td style="vertical-align: top">
                            <br />
                            <ig:WebNumericEditor ID="wneScrapDetph" runat="server" CssClass="textBoxDesign" onkeyPress ="return textbox_number_onkeypress(event)" DataMode="Decimal" Nullable="False" MaxDecimalPlaces="2" MaxLength="3">
                            </ig:WebNumericEditor>
                        </td>
                        </tr>
                        </tr>
                    ...
                    <table>
                        <tr>
                            <td runat="server" id="tdSave">
                                <igtxt:WebImageButton ID="wibSave" runat="server"  ClientIDMode="static"
                                    Text="Grabar" Width="142px" Height="30px" OnClick="wibSave_Click">
                                    <Appearance>
                ...
                <ig:WebDataGrid ID="wdgMain" ClientIDMode="Static" runat="server" Height="350px" Width="800px" 
                    AutoGenerateColumns="False" DataKeyFields="DepthSettingId"
                    ...
                    <Columns>
                        ...
                        <ig:BoundDataField DataFieldName="DepthSettingId" DataType="System.UInt32" Key="DepthSettingId" Hidden="True">
                        ...
                        <ig:BoundDataField DataFieldName="ApplicationName" Key="ApplicationName" CssClass="Center">
                        ...
                        <ig:BoundDataField DataFieldName="BrandName" Key="BrandName" CssClass="Center">
                            <Header Text="Marca" CssClass="HCENTER">
                            </Header>
                        </ig:BoundDataField>
                        ...
                        <ig:BoundDataField DataFieldName="AssetModelName" Key="AssetModelName" CssClass="Center">
                            <Header Text="Modelo">
                            </Header>
                        </ig:BoundDataField>
                        <ig:BoundDataField DataFieldName="ScrapDepth" Key="ScrapDepth" CssClass="Right">
                            <Header Text="Profundidad de Baja">
                            </Header>
                        </ig:BoundDataField>
                    </Columns>
                    <Behaviors>
