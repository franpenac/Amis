<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WucSettingRadio.ascx.cs" Inherits="amis._PresentationLayer.Configuration.WucSettingRadio" %>
    ...
    <ContentTemplate>
        <table class="auto-style6">
            ...
            <tr>
                ...
                <td class="auto-style14">
                    <ig:WebTextEditor ID="wteAssetModelName" Width="200px" CssClass="textBoxDesign" onkeyPress="return textbox_text_onkeypress(event)" runat="server" Height="23px" ></ig:WebTextEditor>
                </td>
            </tr>
            <tr>
                <td></td>
                <td style="vertical-align: top" class="auto-style13">
                    <div style="font-family: Arial; font-size: 13px; padding-top:5px; text-align:right">
                        <asp:Label ID="lblEndLifeDate" runat="server" Text="Dar de baja"></asp:Label>
                    </div>
                </td>
                <td class="auto-style1">
                    <ig:WebDatePicker ID="wdpEndLifeDate" runat="server" DropDownCalendarID="wmcEndLifeDate" DisplayModeFormat="dd/MM/yyyy"></ig:WebDatePicker>
                            <ig:WebMonthCalendar runat="server" Visible="true" ID="wmcEndLifeDate" EnableWeekNumbers="true"
